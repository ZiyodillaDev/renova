...
async function getProducts() {
	const res = await fetch(
		'http://3.123.23.189:8080/v1/product?limit=10&page=1',
		{
			headers: {
...
const upload = () => {
	...
	fetch('http://3.123.23.189:8080/v1/file-upload', {
		method: 'POST',
		headers: {
			Authorization: localData,
		},
...
elPostForm.addEventListener('submit', function (evt) {
	evt.preventDefault();
	// http://3.123.23.189:8080/v1/file-upload
	// http://3.123.23.189:8080/v1/news
	fetch('http://3.123.23.189:8080/v1/news', {
		method: 'POST',
		headers: {
...
elForm.addEventListener('submit', function (evt) {
	...
	fetch('http://3.123.23.189:8080/v1/product', {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: localData,
...
const deleteProduct = (product_id) => {
	fetch(`http://3.123.23.189:8080/v1/product/${product_id}`, {
		method: 'DELETE',
		headers: {
			Authorization: localData,
		},
...
const deleteNews = (product_id) => {
	fetch(`http://3.123.23.189:8080/v1/news/${product_id}`, {
		method: 'DELETE',
		headers: {
			Authorization: localData,
		},
